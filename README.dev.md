...
| Файл | Описание |
|------|----------|
| `homeassistant/components/assist_satellite/entity.py` | **Изменён.** 9 настраиваемых атрибутов с RestoreEntity-персистентностью |
| `homeassistant/components/assist_satellite/__init__.py` | **Изменён.** Регистрация 9 сервисов VAD |

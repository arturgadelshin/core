...
CONF_TRAINING_RECORDING_DIR = "training_recording_dir"
...
DATA_SILERO_VAD = f"{DOMAIN}.silero_vad"

SILERO_MS_PER_CHUNK = 32
SILERO_SAMPLES_PER_CHUNK = 512
SILERO_BYTES_PER_CHUNK = SILERO_SAMPLES_PER_CHUNK * SAMPLE_WIDTH * SAMPLE_CHANNELS
